...
The 'Asset_bundle_tut' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/Asset_bundle_tut/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] Asset_bundle_tut_etl` to your workspace.
